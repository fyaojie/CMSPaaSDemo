...
Pod::Spec.new do |s|
  s.name             = 'CMSPaaSDemo'
  s.version          = '0.1.0'
  s.summary          = 'A short description of CMSPaaSDemo.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/562925462@qq.com/CMSPaaSDemo'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '562925462@qq.com' => 'yaojie.feng@symbio.com' }
  s.source           = { :git => 'https://github.com/562925462@qq.com/CMSPaaSDemo.git', :tag => s.version.to_s }
